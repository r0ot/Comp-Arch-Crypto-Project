...
\begin{figure}[htbp]
	...
	\caption{Public key encryption \cite{EnigmaRef} }
	\label{enigma}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=6cm,keepaspectratio]{img/crypto2.png}
	\caption{Encrypting and Decrypting with Asymmetric Keys \cite{KeyFigure} }
	\label{keytypes}
\end{figure}
...
\bibitem{gpu}
G. J. van den Braak, J. G√≥mez-Luna, J. M. Gonz√°lez-Linares, H. Corporaal and N. Guil, "Configurable XOR Hash Functions for Banked Scratchpad Memories in GPUs," in IEEE Transactions on Computers, vol. 65, no. 7, pp. 2045-2058, July 1 2016.
...
\bibitem{tlsRFC}
J. Salowey and A. Choudhury, "ÄúAES Galois Counter Mode (GCM) Cipher Suites for TLS,"Äù RFC 5288, Aug. 2008.
...
\bibitem{AES2}
J. Rott, "Intel¬Æ Advanced Encryption Standard Instructions (AES-NI)," in Intel, 2012. [Online]. Available: https://software.intel.com/en-us/articles/intel-advanced-encryption-standard-instructions-aes-ni. Accessed: Dec. 14, 2016.

\bibitem{IEEERNG}
G. Taylor and G. Cox, "Behind Intel"Äôs new random-number generator," in IEEE, IEEE Spectrum: Technology, Engineering, and Science News, 2011. [Online]. Available: http://spectrum.ieee.org/computing/hardware/behind-intels-new-randomnumber-generator. Accessed: Dec. 14, 2016.
